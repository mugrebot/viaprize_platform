// Generated by @wagmi/cli@0.1.15 on 4/23/2023 at 7:12:51 PM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link eippyABI}__ and `functionName` set to `"owner"`.
 */
export function useEippyOwner<TSelectData = ReadContractResult<typeof eippyABI, 'owner'>>(
  config: Omit<UseContractReadConfig<typeof eippyABI, 'owner', TSelectData>, 'abi' | 'functionName'> = {} as any,
) {
  return useContractRead({ abi: eippyABI, functionName: 'owner', ...config } as UseContractReadConfig<
    typeof eippyABI,
    'owner',
    TSelectData
  >)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link eippyABI}__.
 */
export function useEippyWrite<TMode extends WriteContractMode, TFunctionName extends string>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<TMode, PrepareWriteContractResult<typeof eippyABI, string>['abi'], TFunctionName>
    : UseContractWriteConfig<TMode, typeof eippyABI, TFunctionName> & {
        abi?: never
      } = {} as any,
) {
  return useContractWrite<TMode, typeof eippyABI, TFunctionName>({ abi: eippyABI, ...config } as any)
}

/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link eippyABI}__ and `functionName` set to `"renounceOwnership"`.
 */
export function useEippyRenounceOwnership<TMode extends WriteContractMode>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof eippyABI, 'renounceOwnership'>['abi'],
        'renounceOwnership'
      > & { functionName?: 'renounceOwnership' }
    : UseContractWriteConfig<TMode, typeof eippyABI, 'renounceOwnership'> & {
        abi?: never
        functionName?: 'renounceOwnership'
      } = {} as any,
) {
  return useContractWrite<TMode, typeof eippyABI, 'renounceOwnership'>({
    abi: eippyABI,
    functionName: 'renounceOwnership',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link eippyABI}__ and `functionName` set to `"transferOwnership"`.
 */
export function useEippyTransferOwnership<TMode extends WriteContractMode>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        TMode,
        PrepareWriteContractResult<typeof eippyABI, 'transferOwnership'>['abi'],
        'transferOwnership'
      > & { functionName?: 'transferOwnership' }
    : UseContractWriteConfig<TMode, typeof eippyABI, 'transferOwnership'> & {
        abi?: never
        functionName?: 'transferOwnership'
      } = {} as any,
) {
  return useContractWrite<TMode, typeof eippyABI, 'transferOwnership'>({
    abi: eippyABI,
    functionName: 'transferOwnership',
    ...config,
  } as any)
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link eippyABI}__.
 */
export function usePrepareEippyWrite<TFunctionName extends string>(
  config: Omit<UsePrepareContractWriteConfig<typeof eippyABI, TFunctionName>, 'abi'> = {} as any,
) {
  return usePrepareContractWrite({ abi: eippyABI, ...config } as UsePrepareContractWriteConfig<
    typeof eippyABI,
    TFunctionName
  >)
}
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link eippyABI}__ and `functionName` set to `"renounceOwnership"`.
 */
export function usePrepareEippyRenounceOwnership(
  config: Omit<UsePrepareContractWriteConfig<typeof eippyABI, 'renounceOwnership'>, 'abi' | 'functionName'> = {} as any,
) {
  return usePrepareContractWrite({
    abi: eippyABI,
    functionName: 'renounceOwnership',
    ...config,
  } as UsePrepareContractWriteConfig<typeof eippyABI, 'renounceOwnership'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link eippyABI}__ and `functionName` set to `"transferOwnership"`.
 */
export function usePrepareEippyTransferOwnership(
  config: Omit<UsePrepareContractWriteConfig<typeof eippyABI, 'transferOwnership'>, 'abi' | 'functionName'> = {} as any,
) {
  return usePrepareContractWrite({
    abi: eippyABI,
    functionName: 'transferOwnership',
    ...config,
  } as UsePrepareContractWriteConfig<typeof eippyABI, 'transferOwnership'>)
}

/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link eippyABI}__.
 */
export function useEippyEvent<TEventName extends string>(
  config: Omit<UseContractEventConfig<typeof eippyABI, TEventName>, 'abi'> = {} as any,
) {
  return useContractEvent({ abi: eippyABI, ...config } as UseContractEventConfig<typeof eippyABI, TEventName>)
}

/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link eippyABI}__ and `eventName` set to `"OwnershipTransferred"`.
 */
export function useEippyOwnershipTransferredEvent(
  config: Omit<UseContractEventConfig<typeof eippyABI, 'OwnershipTransferred'>, 'abi' | 'eventName'> = {} as any,
) {
  return useContractEvent({ abi: eippyABI, eventName: 'OwnershipTransferred', ...config } as UseContractEventConfig<
    typeof eippyABI,
